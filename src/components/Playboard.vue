    ...
    <div class="w-full h-full flex justify-center items-center">
      ...
      >
        <div class="mx-1 h-8 flex justify-center items-center relative">
          ...
          <div
            class="z-50 ml-2 w-5 h-5 mt-0.5 flex justify-center items-center border-2 border-[#b1aea4] text-[#b1aea4] rounded-full"
      ...
      >
        <div
          class="h-5 absolute top-2 right-2 border-2 border-[#b1aea4] text-[#b1aea4] rounded-full"
          @click="handleShowInstructions"
        >
          <i-healthicons-question-mark class="text-sm" />
        </div>
    ...
    <Teleport to="body">
      ...
      >
        ...
        <div class="">
          ...
          <p class="mb-2">
            錯誤的線索將在每回合移至正確的位置。正確的線索可獲得2至5分。完美分數為28分。
          </p>
